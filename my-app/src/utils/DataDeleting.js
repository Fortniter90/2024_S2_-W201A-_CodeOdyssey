...
export const deleteCourse = async (courseId) => {
  try {
    const response = await axios.delete(`${backendUrl}/courses/${courseId}`);
...
export const deleteLesson = async (courseId, lessonId) => {
  try {
    const response = await axios.delete(`${backendUrl}/courses/${courseId}/lessons/${lessonId}`);
    return response.data;
  } catch (error) {
...
export const deleteTest = async (courseId, lessonId, testId) => {
  try {
    const response = await axios.delete(`${backendUrl}/courses/${courseId}/lessons/${lessonId}/tests/${testId}`);
    return response.data;
  } catch (error) {
